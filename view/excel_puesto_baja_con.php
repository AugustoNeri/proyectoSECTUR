...
if (!@mysql_select_db($db, $conexion))
   {
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_tipo_funcion tfj on pj.id_funcion=tfj.id_funcion where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.id_nsalarial='".$ns."'order by id_ur asc";
	}
	if($numcon==2){
			$nom=$_POST['nom'];
			$sql =  "Select p.id_puesto ,p.id_ramo,p.id_ur,p.codigo_puesto,p.deno_puesto,p.id_ze,rt.r_tabular,p.consecutivo,tp.tipo_plaza,
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_rtabular rj on pj.id_rtabular=rj.id_rtabular 
				   left outer join tcat_tipo_plaza tj on pj.id_tplaza=tj.id_tplaza 
				   left outer join tcat_tipo_funcion tfj on pj.id_funcion=tfj.id_funcion where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.deno_puesto like '%".$nom."%' order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_rtabular rj on pj.id_rtabular=rj.id_rtabular 
				   left outer join tcat_tipo_plaza tj on pj.id_tplaza=tj.id_tplaza 
				   left outer join tcat_tipo_funcion tfj on pj.id_funcion=tfj.id_funcion where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.id_ur='".$ur."'  order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_rtabular rj on pj.id_rtabular=rj.id_rtabular 
				   left outer join tcat_tipo_plaza tj on pj.id_tplaza=tj.id_tplaza 
				   left outer join tcat_tipo_funcion tfj on pj.id_funcion=tfj.id_funcion where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.id_ur='".$ur."' and p.id_nsalarial='".$ns."' order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_rtabular rj on pj.id_rtabular=rj.id_rtabular 
				   left outer join tcat_tipo_plaza tj on pj.id_tplaza=tj.id_tplaza 
				   left outer join tcat_tipo_funcion tfj on pj.id_funcion=tfj.id_funcion where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.deno_puesto like '%".$nom."%' and p.id_nsalarial='".$ns."'order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_rtabular rj on pj.id_rtabular=rj.id_rtabular 
				   left outer join tcat_tipo_plaza tj on pj.id_tplaza=tj.id_tplaza 
				   left outer join tcat_tipo_funcion tfj on pj.id_funcion=tfj.id_funcion where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.deno_puesto like '%".$nom."%' and p.id_ur='".$ur."'order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_rtabular rj on pj.id_rtabular=rj.id_rtabular 
				   left outer join tcat_tipo_plaza tj on pj.id_tplaza=tj.id_tplaza 
				   left outer join tcat_tipo_funcion tfj on pj.id_funcion=tfj.id_funcion where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.id_ur='".$ur."' and (p.deno_puesto like '%".$nom."%') and p.id_nsalarial='".$ns."' order by id_ur asc";
