...
if (!@mysql_select_db($db, $conexion))
   {
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.codigo_puesto<>'' and p.id_nsalarial='".$ns."'order by id_ur asc";
	}
	if($numcon==2){
			$nom=$_POST['nom'];
			$sql =  "Select p.id_puesto ,p.id_ramo,p.id_ur,p.codigo_puesto,p.deno_puesto,p.id_ze,p.id_ze_rusp,rt.r_tabular,p.consecutivo,tp.tipo_plaza,
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join rfi_riuf rfi on p.id_rfi_riuf=rfi.id_rfi_riuf
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.codigo_puesto<>'' and p.deno_puesto like '%".$nom."%' order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join rfi_riuf rfi on p.id_rfi_riuf=rfi.id_rfi_riuf
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.codigo_puesto<>'' and p.id_ur='".$ur."'  order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join rfi_riuf rfi on p.id_rfi_riuf=rfi.id_rfi_riuf
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.codigo_puesto<>'' and p.id_ur='".$ur."' and p.id_nsalarial='".$ns."' order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join rfi_riuf rfi on p.id_rfi_riuf=rfi.id_rfi_riuf
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.codigo_puesto<>'' and p.deno_puesto like '%".$nom."%' and p.id_ur='".$ur."'order by id_ur asc";
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join rfi_riuf rfi on p.id_rfi_riuf=rfi.id_rfi_riuf
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.codigo_puesto<>'' and p.id_ur='".$ur."' and (p.deno_puesto like '%".$nom."%') and p.id_nsalarial='".$ns."' order by id_ur asc";
 ...
 //Ancho de las columnas
			...
			header('Content-Disposition: attachment;filename="MAESTROS_PUESTOS_SPC_CON.xls"');
			header('Cache-Control: max-age=0');
