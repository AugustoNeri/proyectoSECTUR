...
if (!$_POST /*and !$_Get*/)
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 order by id_puesto asc,id_ur asc ";
 ...
 //Ancho de las columnas
			...
			header('Content-Disposition: attachment;filename="MAESTROS_PUESTOS_SPC.xls"');
			header('Cache-Control: max-age=0');
