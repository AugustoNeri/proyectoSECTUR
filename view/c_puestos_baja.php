...
<?php
	...
	pj.ordinal_cp as ordinal_cp_j,p.observaciones
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') order by id_ur asc,cod_puesto asc,deno_puesto asc";
	...
	?>
	   ...
	   <input type="submit" value="Ver todos los puestos" onclick = "location='c_puestos.php'" class='btn btn-default'/>
		  <input type='submit' class='btn btn-default' onclick="location='excel_puesto_baja.php'" value='Exportar tabla a excel '> 
		</div>	
	  </center>
	  <?php
...
while ($row=mysql_fetch_array ($resultado1))
{
   ...
   echo '</table>';
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_ingreso_plaza tip on p.id_ingr_plaza=tip.id_ingr_plaza
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.id_nsalarial='".$ns."'order by id_puesto asc,id_ur asc";
	$numcon=1;
			$resultado1= @ mysql_query ($sql);
			if (!$resultado1)
			{
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_ingreso_plaza tip on p.id_ingr_plaza=tip.id_ingr_plaza
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.deno_puesto like '%".$nom."%' order by id_puesto asc,id_ur asc";
	$numcon=2;
			$resultado1= @ mysql_query ($sql);
			if (!$resultado1)
			{
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_ingreso_plaza tip on p.id_ingr_plaza=tip.id_ingr_plaza
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.id_ur='".$ur."' order by id_puesto asc,id_ur asc";
		$numcon=3;
			$resultado1= @ mysql_query ($sql);
				if (!$resultado1)
				{
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_ingreso_plaza tip on p.id_ingr_plaza=tip.id_ingr_plaza
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.id_ur='".$ur."' and p.id_nsalarial='".$ns."' order by id_puesto asc,id_ur asc";
				$numcon=4;
				$resultado1= @ mysql_query ($sql);
				if (!$resultado1)
				{
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_ingreso_plaza tip on p.id_ingr_plaza=tip.id_ingr_plaza
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.deno_puesto like '%".$nom."%' and p.id_nsalarial='".$ns."'order by id_puesto asc,id_ur asc";
					$numcon=5;
					$resultado1= @ mysql_query ($sql);
					if (!$resultado1)
					{
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_ingreso_plaza tip on p.id_ingr_plaza=tip.id_ingr_plaza
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.deno_puesto like '%".$nom."%' and p.id_ur='".$ur."' order by id_puesto asc,id_ur asc";
						$numcon=6;
						$resultado1= @ mysql_query ($sql);
						if (!$resultado1)
						{
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_literales tl on p.id_literal=tl.id_literal
				   left outer join tcat_tipo_ingreso_plaza tip on p.id_ingr_plaza=tip.id_ingr_plaza
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones<>'NA' and p.observaciones<>'') and p.id_ur='".$ur."' and (p.deno_puesto like '%".$nom."%') and p.id_nsalarial='".$ns."' order by id_puesto asc,id_ur asc";
							$numcon=7;
							$resultado1= @ mysql_query ($sql);
							if (!$resultado1)
							{
	...
	if($num_regis==0){
		echo "NO SE ENCONTRARON CONCIDENCIAS";
		 ...
		 echo "<form method='post' action='excel_puesto_baja_con.php' class='form-horizontal' role='form'> \n
	...
	?>
	   <input type="submit" value="Visualizar todos los puestos" onclick = "location='c_puestos.php'" class='btn btn-default'/>
	   <input type="submit" value="Visualizar solo los de SPC" onclick = "location='c_puestos_spc.php'" class='btn btn-default'/>
		  </div
	  </center>
	  <table class="table table-striped" align="center">
    <tr>
