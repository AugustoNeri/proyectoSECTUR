...
if (!$_POST /*and !$_Get*/)
	...
	from puestos p left outer join tcat_rtabular rt on p.id_rtabular = rt.id_rtabular 
				   ...
				   left outer join tcat_tipo_servidor_publico tts on p.id_tservidor=tts.id_tservidor where p.id_puesto>0 and (p.observaciones='NA' or p.observaciones='') order by id_puesto asc,id_ur asc ";
